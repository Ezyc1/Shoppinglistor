...
DATABASES = {
    'default': {
        ...
        'PASSWORD': os.environ.get('POSTGRES_PASSWORD', 'gjRX3K0CkSDl'),  # Ideally, keep this secure
        'HOST': os.environ.get('POSTGRES_HOST', 'ep-quiet-base-a4h8egoh-pooler.us-east-1.aws.neon.tech'),
